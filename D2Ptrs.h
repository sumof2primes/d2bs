...
#define ASMPTR(d1, v1, o1) extern DWORD d1##_##v1;
	...
	FUNCPTR(D2CLIENT, FindClientSideUnit, UnitAny* __fastcall, (DWORD dwId, DWORD dwType), 0x63990) // Updated 1.14d
																									// //00463990-BASE
	FUNCPTR(D2CLIENT, FindServerSideUnit, UnitAny* __fastcall, (DWORD dwId, DWORD dwType), 0x639B0) // Updated 1.14d
																									// //004639B0-BASE
	...
	// FUNCPTR(D2CLIENT, GetMercUnit, UnitAny* __fastcall, (void), 0x78A90) //Updated 1.14d //00478A90-BASE 478F20 with
	// 7 0 args
	...
	FUNCPTR(
		...
		GetItemName,
		BOOL __fastcall,
		(UnitAny * pItem, wchar_t* wBuffer, DWORD dwSize),
		0x8C060) // Updated 1.14d //0048C060-BASE
	FUNCPTR(
		D2CLIENT, LoadItemDesc, BOOL __stdcall, (UnitAny * pItem, int type), 0x8DD90) // Updated 1.14d //0048DD90-BASE
	...
	FUNCPTR(
		...
		SetUIVar,
		DWORD __fastcall,
		(DWORD varno, DWORD howset, DWORD unknown1),
		0x55F20)                                                            // Updated 1.14d //00455F20-BASE
	...
	FUNCPTR(
		...
		AddAutomapCell,
		void __fastcall,
		(AutomapCell * aCell, AutomapCell** node),
		0x57B00) // Updated 1.14d //00457B00-BASE
	FUNCPTR(
		D2CLIENT,
		RevealAutomapRoom,
		void __stdcall,
		(Room1 * pRoom1, DWORD dwClipFlag, AutomapLayer* aLayer),
		0x58F40) // Updated 1.14d //00458F40-BASE
	...
	FUNCPTR(
		...
		ClickMap,
		void __fastcall,
		(DWORD MouseFlag, DWORD x, DWORD y, DWORD Type),
		0x62D00) // Updated 1.14d //00462D00-BASE
	FUNCPTR(
		D2CLIENT,
		LeftClickItem_I,
		void __stdcall,
	...
	FUNCPTR(
		...
		TestPvpFlag,
		DWORD __fastcall,
		(DWORD dwUnitId1, DWORD dwUnitId2, DWORD dwFlag),
		0xDC440) // Updated 1.14d //004DC440-BASE
	...
	// VARPTR(D2CLIENT, ScreenCovered, DWORD, 0x1E8F9) // unused, appears to be an int specifying which screens (if any)
	// are opened...
	...
	FUNCPTR(D2COMMON, GetLevel, Level* __fastcall, (ActMisc * pMisc, DWORD dwLevelNo), 0x242AE0) // Updated 1.14d
																								 // //00642AE0-BASE
	...
	FUNCPTR(
		...
		GetStatList,
		StatList* __stdcall,
		(UnitAny * pUnit, DWORD dwUnk, DWORD dwMaxEntries),
		0x2257D0) // Updated 1.14d //006257D0-BASE
	FUNCPTR(
		D2COMMON,
		CopyStatList,
		DWORD __stdcall,
		(StatList * pStatList, Stat* pStatArray, DWORD dwMaxEntries),
		0x225C90) // Updated 1.14d //0625C90-BASE
	FUNCPTR(
		D2COMMON,
		GetUnitStat,
		DWORD __stdcall,
		(UnitAny * pUnit, DWORD dwStat, DWORD dwStat2),
		0x225480) // Updated 1.14d //00625480-BASE
	FUNCPTR(D2COMMON, GetUnitState, int __stdcall, (UnitAny * pUnit, DWORD dwStateNo), 0x239DF0) // Updated 1.14d
																								 // //00639DF0-BASE
	...
	FUNCPTR(
		...
		CheckUnitCollision,
		DWORD __stdcall,
		(UnitAny * pUnitA, UnitAny* pUnitB, DWORD dwBitMask),
		0x222AA0)                                                                      // Updated 1.14d //00622AA0-BASE
	...
	FUNCPTR(D2COMMON, GetTargetUnitType, Path* __stdcall, (Path * pPath), 0x773C0)
		...
		FUNCPTR(
			...
			GetSkillLevel,
			INT __stdcall,
			(UnitAny * pUnit, Skill* pSkill, BOOL bTotal),
			0x2442A0) // Updated 1.14d //006442A0-BASE

	FUNCPTR(
		D2COMMON,
		GetItemLevelRequirement,
		DWORD __stdcall,
		(UnitAny * pItem, UnitAny* pPlayer),
		0x22BA60) // Updated 1.14d //0062BA60-BASE

	FUNCPTR(
		D2COMMON,
		GetItemPrice,
		DWORD __stdcall,
		(UnitAny * MyUnit, UnitAny* pItem, DWORD U1_, DWORD U2_, DWORD U3_, DWORD U4_),
		0x22FDC0) // Updated 1.14d //0062FDC0-BASE
	FUNCPTR(
		D2COMMON,
		GetRepairCost,
		DWORD __stdcall,
		(DWORD _1, UnitAny* pUnit, DWORD dwNpcId, DWORD dwDifficulty, DWORD dwItemPriceList, DWORD _2),
	...
	FUNCPTR(D2COMMON, GetItemFromInventory, UnitAny* __stdcall, (Inventory * inv), 0x23B2C0)     // Updated 1.14d
																								 // //0063B2C0-BASE
	FUNCPTR(D2COMMON, GetNextItemFromInventory, UnitAny* __stdcall, (UnitAny * pItem), 0x23DFA0) // Updated 1.14d
																								 // //0063DFA0-BASE

	FUNCPTR(
		D2COMMON,
		GenerateOverheadMsg,
		OverheadMsg* __stdcall,
		(DWORD dwUnk, CHAR* szMsg, DWORD dwTrigger),
		0x261110) // Updated 1.14d //00661110-BASE
	FUNCPTR(D2COMMON, FixOverheadMsg, VOID __stdcall, (OverheadMsg * pMsg, DWORD dwUnk), 0x261230) // Updated 1.14d
																								   // //00661230-BASE
	...
	FUNCPTR(
		...
		0x21A070) // Updated 1.14d //0061A070-BASE
	FUNCPTR(
		D2COMMON,
		RemoveRoomData,
		void __stdcall,
		(Act * ptAct, int LevelId, int Xpos, int Ypos, Room1* pRoom),
		0x21A0C0) // Updated 1.14d //0061A0C0-BASE

	FUNCPTR(
		D2COMMON,
		GetQuestFlag,
		int __stdcall,
		(void* QuestInfo, DWORD dwAct, DWORD dwQuest),
		0x25C310) // Updated 1.14d //0065C310-BASE
	...
	FUNCPTR(
		...
		CheckWaypoint,
		DWORD __stdcall,
		(DWORD WaypointTable, DWORD dwLevelId),
		0x260E50) // Updated 1.14d //00660E50-BASE
	...
	FUNCPTR(
		D2COMMON, FindRoom1, Room1* __stdcall, (Act * pAct, int x, int y), 0x219DA3) // Updated 1.14d //00619DA3-BASE
	FUNCPTR(
		D2COMMON,
		GetItemPalette,
		int __stdcall,
		(UnitAny * pPlayer, UnitAny* pItem, BYTE* pColor, int nTransType),
	...
	FUNCPTR(D2NET, SendPacket, void __stdcall, (size_t aLen, DWORD arg1, BYTE* aPacket), 0x12AE50) // Updated 1.14d
																								   // //0052AE50-BASE
	FUNCPTR(
		D2NET, ReceivePacket, void __fastcall, (BYTE * aPacket, DWORD aLen), 0x12AEB0) // Updated 1.14d //0052AEB0-BASE
	FUNCPTR(
		D2NET,
		ReceivePacket_I,
		void __fastcall,
		(BYTE * aPacket, DWORD aLen, int* arg3),
		0x12B920) // Updated 1.14d //0052B920-BASE
	...
	// FUNCPTR(D2GFX, DrawAutomapCell, void __stdcall, (CellContext *context, DWORD xpos, DWORD ypos, RECT *cliprect,
	// DWORD bright), 0xF6510) //Updated 1.14d
	// //004F6510-BASE
	FUNCPTR(
		D2GFX,
		DrawRectangle,
		void __stdcall,
		(int X1, int Y1, int X2, int Y2, DWORD dwColor, DWORD dwTrans),
		0xF6300) // Updated 1.14d //004F6300-BASE
	FUNCPTR(
		D2GFX,
		DrawLine,
		void __stdcall,
		(int X1, int Y1, int X2, int Y2, DWORD dwColor, DWORD dwUnk),
		0xF6380) // Updated 1.14d //004F6380-BASE
	FUNCPTR(
		D2GFX,
		DrawAutomapCell2,
		void __stdcall,
		(CellContext * context, DWORD xpos, DWORD ypos, DWORD bright2, DWORD bright, BYTE* coltab),
	...
	FUNCPTR(
		...
		PrintChannelText_,
		void __fastcall,
		(int unused, char* szText, DWORD dwColor),
		0x47AB0) // Updated 1.14d //00447AB0-BASE
	...
	ASMPTR(D2MULTI, ChannelChat_I, 0x14BE6) ASMPTR(D2MULTI, ChannelEmote_I, 0x14856) ASMPTR(
		D2MULTI, ChannelWhisper_I, 0x142F0) ASMPTR(D2MULTI, ChannelInput_I, 0x428D0) // Updated 1.14d //004428D0-BASE
	...
	FUNCPTR(
		...
		InitCellFile,
		VOID __stdcall,
		(LPVOID File, CellFile** Out, LPSTR SourceFile, DWORD Line, DWORD FileVersion, LPSTR Filename),
	...
	FUNCPTR(D2WIN, SetControlText, void* __fastcall, (Control * box, const wchar_t* txt), 0xFF5A0) // Updated 1.14d
																								   // //004FF5A0-BASE
	FUNCPTR(D2WIN, DrawSprites, void __fastcall, (void), 0xF9870) // Updated 1.14d //004F9870-BASE
	FUNCPTR(D2WIN, LoadCellFile, CellFile* __fastcall, (const char* szFile, int Type), 0xFA9B0) // Updated 1.14d
																								// //004FA9B0-BASE
	...
	FUNCPTR(
		...
		DrawText,
		void __fastcall,
		(const wchar_t* wStr, int xPos, int yPos, DWORD dwColor, DWORD dwUnk),
		0x102320) // Updated 1.14d //00502320-BASE
	FUNCPTR(
		D2WIN,
		GetTextSize,
		DWORD __fastcall,
		(wchar_t * wStr, DWORD* dwWidth, DWORD* dwFileNo),
		0x102520)                                                           // Updated 1.14d //00502520-BASE
	...
	FUNCPTR(
		...
		SetEditBoxCallback,
		VOID __fastcall,
		(Control * pControl, BOOL(__stdcall* FunCallBack)(Control* pControl, DWORD dwInputType, char* pChar)),
		0xFDAD0) // Updated 1.14d //004FDAD0-BASE
	FUNCPTR(
		D2WIN,
		SetEditBoxProc,
		void __fastcall,
		(Control * box, BOOL(__stdcall* FunCallBack)(Control*, DWORD, DWORD)),
		0xFDAD0)                                                                 // Updated 1.14d //004FDAD0-BASE
	...
	FUNCPTR(
		...
		InitMPQ,
		DWORD __fastcall,
		(const char* mpqfile, char* mpqname, int v4, int v5),
		0x117332) // Updated 1.14d //00517332-BASE
...
#define D2CLIENT_RightClickItem(x, y, loc, player, invdata) \
	D2CLIENT_ClickItemRight_ASM(x, y, loc, (DWORD)player, (DWORD)invdata)
#define D2CLIENT_ClickBeltRight(pPlayer, pInventory, dwShift, dwPotPos) \
	D2CLIENT_ClickBeltRight_ASM((DWORD)pPlayer, (DWORD)pInventory, dwShift, dwPotPos)
